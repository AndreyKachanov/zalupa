...
<script
    src="{{ mix('js/' . ($pageWithVue ? 'app.js' : 'app_admin.js'), (config('app.env') == 'local') ? 'build' : '') }}"></script>
...
{{--        </script>--}}
{{--        <noscript>--}}
{{--            <div><img src="https://mc.yandex.ru/watch/92132246" style="position:absolute; left:-9999px;" alt=""/></div>--}}
{{--        </noscript>--}}
{{--    @endif--}}
{{--@endenv--}}
</body>
